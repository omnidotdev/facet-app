/* @ts-self-types="./facet_kernel.d.ts" */
...
export class MeshResult {
     ...
     */
    get triangleCount() {
        const ret = wasm.meshresult_triangleCount(this.__wbg_ptr);
        return ret >>> 0;
    }
}
 ...
 * @returns {MeshResult}
 */
export function evaluate(op_json) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('facet_kernel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
